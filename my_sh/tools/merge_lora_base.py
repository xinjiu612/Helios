...
pipe.load_lora_weights(
    "ablation_stage_1_post/checkpoint-1500/pytorch_lora_weights.safetensors",
...
load_extra_components(
    args,
    transformer,
    "ablation_stage_1_post/checkpoint-1500/transformer_partial.pth",
)

pipe.fuse_lora()
pipe.unload_lora_weights()
pipe.transformer.save_pretrained(
    "ablation_stage_1_post/merge_1500/transformer"
)
