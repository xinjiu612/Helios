    ...
    for idx, batch in enumerate(dataloader):
        ...
        for (
            ...
            temp_to_save = {
                ...
                "image_latents": cur_image_latent.cpu().detach(),
                "fake_image_latents": cur_fake_image_latent.cpu().detach(),
...
if __name__ == "__main__":
    ...
    base_video_path = "/beijing-c/datasets/hxj_video_model/SpatialVID/SpatialVID"
    video_paths = [
        "",
    ]
    base_output_latent_path = "/world_model_data/SpatialVID/5fps"
    output_latent_paths = [
        "latents_short_straight_2",
    ]
    ...
    csv_paths = [
        "helios_data_straight_5hz.part_002_of_002.part_002_of_002.json",
    ]
