...
from helios.dataset.dataloader_mp4_dist_5hz import BucketedFeatureDataset, BucketedSampler, collate_fn
...
def metadata_cache_path(json_file, latent_window_size):
...
def ensure_metadata_cache(
    ...
    cache_file = metadata_cache_path(json_file, latent_window_size)
...
def save_batch_payloads(batch_payloads):
    ...
    for payload in batch_payloads:
        ...
        temp_to_save = {
            ...
            "latent_window_size": payload["latent_window_size"],
            "frame_window_size": payload["frame_window_size"],
        }
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output_latent_path",
        type=str,
        default="latents_short_straight_lw3",
    ...
    parser.add_argument("--latent_window_size", type=int, default=3, help="Latent frames per 5hz chunk")
